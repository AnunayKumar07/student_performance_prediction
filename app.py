...
# ==============================
def train_model():
    """Train the Random Forest model and initialize scaler."""
    global model, scaler
...
def ensure_model():
    """Make sure model & scaler exist (important for Vercel)."""
    global model, scaler
...
def encode_categorical_features(data):
    ...
    for feature, mapping in ENCODING_MAPS.items():
        if feature in encoded:
            encoded[feature] = mapping.get(encoded[feature], 2)  # default 2
    return encoded
